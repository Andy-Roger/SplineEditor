...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
        ...
        public delegate void onGizmoInteraction(bool isTransforming);
        public static event onGizmoInteraction onGizmoInteractionEvent;
		...
		IEnumerator TransformSelected(TransformType transType)
		{
            isTransforming = true;
            //*********************************************************
            onGizmoInteractionEvent(isTransforming);
